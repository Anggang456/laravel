                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            ...
                            {
                                $notification = \App\Models\PesananDetail::where('pesanan_id', $pesanan_utama->id)->count();
                            }
                            ...
                            <a class="btn btn-outline-dark" href="{{ url('checkout') }}" role="button">
                                ...
                                <span class="badge bg-dark text-white ms-1 rounded-pill">{{ $notification??'0' }}</span>
                            </a>
